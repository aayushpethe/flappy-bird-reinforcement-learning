...
class Agent:
    ...
    def run(self, is_training=True, render=False): # while training render is false and in testing render is true
        ...
        if is_training:
            memory = ReplayMemory(self.reply_memory_size)
        ...
        for episode in itertools.count():
            ...
            if is_training:
                #epsilon decay - do only for training not for testing
            ...
            #env.close() - comment out because we want to manually stop
